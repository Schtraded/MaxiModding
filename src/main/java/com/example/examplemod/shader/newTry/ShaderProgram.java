...
public abstract class ShaderProgram {
    ...
    private static int loadShader(ResourceLocation location, int type) {
        String shaderSource = ResourceUtil.loadResourceAsString(location);
        ...
        if (GL20.glGetShaderi(shaderID, GL20.GL_COMPILE_STATUS) == 0) {
            ...
            System.err.println("Could not compile shader: " + location);
            System.exit(-1);
        }
